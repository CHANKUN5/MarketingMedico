  ...
  return (
    <>
      ...
      >
        <div 
          style={{
            backgroundImage: 'url("/ANÁLISIS DE DATOS Y REPORTES.jpg")',
        ...
        >
          <h1 className="display-4 fw-bold mb-3">Convierte tus datos en decisiones estratégicas</h1>
        </div>
      </section>
            ...
            <Col lg={10}>
              <div className="text-center">
                ...
                <p className="text-dark mb-4" style={{ fontSize: '1.1rem' }}>
                  Transformamos datos en información valiosa para tomar mejores decisiones.
                </p>
                <p className="text-primary fw-bold mb-0" style={{ fontSize: '1rem' }}>
                  INCLUYE: Análisis de métricas, KPIs y dashboards interactivos.
                </p>
              </div>
            </Col>
          </Row>
