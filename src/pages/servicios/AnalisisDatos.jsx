...
export default function AnalisisDatos() {
  const currentService = services[4]
    ...
    <>
      ...
      <section className="py-5">
        <Container>
          <Row className="mb-5">
            <Col lg={8}>
              <h2 className="fw-bold mb-4">Decisiones basadas en datos</h2>
              <p className="text-muted mb-4">
                Transformamos tus datos en insights accionables mediante análisis 
                profundos y reportes visuales que te ayudan a tomar mejores decisiones.
              </p>
            ...
            <Col lg={4}>
              <Card className="shadow-sm border-0 sticky-top" style={{ top: '100px' }}>
                <Card.Body className="p-4">
                  <h5 className="fw-bold mb-3">Analiza tus datos</h5>
                  <p className="text-muted small mb-4">
                    Descubre el potencial oculto en tu información.
                  </p>
                  <Button 
                    as={Link} 
          ...
          <Row className="mb-5">
            <Col>
              <h3 className="fw-bold mb-4">Ventajas del análisis de datos</h3>
              <Row className="g-4">
                <Col md={4}>
                  <div className="text-center p-4">
                    ...
                    <h5 className="fw-bold mb-3">Visualización clara</h5>
                    <p className="text-muted small">
                      Dashboards intuitivos y fáciles de entender
                    </p>
                  </div>
                </Col>
                <Col md={4}>
                  <div className="text-center p-4">
                    ...
                    <h5 className="fw-bold mb-3">Métricas personalizadas</h5>
                    <p className="text-muted small">
                      KPIs adaptados a tus objetivos específicos
                    </p>
                  </div>
                </Col>
                <Col md={4}>
                  <div className="text-center p-4">
                    ...
                    <h5 className="fw-bold mb-3">Insights accionables</h5>
                    <p className="text-muted small">
