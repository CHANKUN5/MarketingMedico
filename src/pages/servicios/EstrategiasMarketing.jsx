...
export default function EstrategiasMarketing() {
  ...
  const relatedServices = services.filter(s => s.id !== currentService.id).slice(0, 4)
  ...
  return (
    <>
      ...
      >
        <div 
          style={{
            backgroundImage: 'url("/ESTRATEGIAS DE MARKETING DIGITAL.jpeg")',
        ...
        >
          <h1 className="display-4 fw-bold mb-3">Impulsamos el crecimiento digital de tu clínica</h1>
        </div>
      </section>
            ...
            <Col lg={10}>
              <div className="text-center">
                ...
                <p className="text-dark mb-4" style={{ fontSize: '1.1rem' }}>
                  Implementamos la presencia online con campañas inteligentes y optimizadas.
                </p>
                <p className="text-primary fw-bold mb-0" style={{ fontSize: '1rem' }}>
                  INCLUYE: Gestión de campañas publicitarias, publicidad en redes sociales y SEO.
                </p>
              </div>
            </Col>
          </Row>
