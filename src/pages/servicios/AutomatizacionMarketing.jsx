  ...
  return (
    <>
      ...
      >
        <div 
          style={{
            backgroundImage: 'url("/AUTOMATIZACIÓN DEL MARKETING.jpg")',
        ...
        >
          <h1 className="display-4 fw-bold mb-3">Automatiza procesos claves y mantén una comunicación constante</h1>
        </div>
      </section>
