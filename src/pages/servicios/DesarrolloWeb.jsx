  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold mb-3">Creamos páginas web modernas, rápidas y alineadas a tu marca</h1>
        </div>
      </section>
            ...
            <Col lg={10}>
              <div className="text-center">
                ...
                <p className="text-dark mb-4" style={{ fontSize: '1.1rem' }}>
                  Creamos sitios web modernos, funcionales y alineados a tu identidad visual.
                </p>
                <p className="text-primary fw-bold mb-0" style={{ fontSize: '1rem' }}>
                  INCLUYE: Optimización móvil y soporte continuo.
                </p>
              </div>
            </Col>
          </Row>
