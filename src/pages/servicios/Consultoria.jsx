  ...
  return (
    <>
      ...
      >
        <div 
          style={{
            backgroundImage: 'url("/CONSULTORÍA Y ESTRATEGIA.jpg")',
        ...
        >
          <h1 className="display-4 fw-bold mb-3">Te guiamos con soluciones digitales adaptadas a tu negocio</h1>
        </div>
      </section>
            ...
            <Col lg={10}>
              <div className="text-center">
                ...
                <p className="text-dark mb-4" style={{ fontSize: '1.1rem' }}>
                  Guiamos tu marca hacia una presencia digital sólida.
                </p>
                <p className="text-primary fw-bold mb-0" style={{ fontSize: '1rem' }}>
                  INCLUYE: Auditorías, asesorías y planes de marketing personalizados.
                </p>
              </div>
            </Col>
          </Row>
