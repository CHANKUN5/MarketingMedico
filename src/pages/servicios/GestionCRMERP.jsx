            ...
            <Col lg={10}>
              <div className="text-center">
                <h2 className="fw-bold text-primary mb-4">
                  GESTIÓN DE CRM Y ERP
                </h2>
                <p className="text-dark mb-4" style={{ fontSize: '1.1rem' }}>
                  Integración y personalización de sistemas para optimizar la gestión de tu negocio.
                </p>
                <p className="text-primary fw-bold mb-0" style={{ fontSize: '1rem' }}>
                  INCLUYE: Implementación de CRM para relación con pacientes y ERP para gestión digital.
                </p>
              </div>
            </Col>
          </Row>
